...
const images = [
  {
    url: 'https://www.rollingstone.com/wp-content/uploads/2021/12/phish-nye-canceled.jpg?w=1581&h=1054&crop=1',
    title: 'Phish Quiz',
    width: '40%',
  ...
  return (
    <Container component="section" sx={{ mt: 8, mb: 4 }}>
      <Typography variant="h4" marked="center" align="center" component="h2">
        Check out these other Band Meeting features while you're here:
      </Typography>
